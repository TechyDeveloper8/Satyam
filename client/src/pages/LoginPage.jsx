...
export const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (addToast) addToast('Welcome back to Aether!', 'success');
      navigate('/account');
    } catch (err) {
      if (addToast) addToast('Authentication failed', 'error');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="glass-panel p-8 rounded-3xl border border-white/80 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-black text-slate-900 tracking-tight">Sign In to Aether</h2>
          <p className="text-xs text-slate-500">Access your saved wishlist, order tracking, and preferences</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-white border border-slate-200 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-slate-900"
              />
              <button
                type="button"
